...
const AdminHome = () => {
  ...
  const fetchBookedLeads = async () => {
    try {
      const response = await fetch('https://vendor.safeshiphub.com/api/admin/booked-leads', {
        headers: {
  ...
  const updateBookedStatusFromSheet = async () => {
    try {
      const response = await fetch('https://vendor.safeshiphub.com/api/admin/update-lead-booked-status', {
        method: 'PUT',
        headers: {
  ...
  const handleUpdate = async () => {
    try {
      ...
      const response = await fetch(`https://vendor.safeshiphub.com/api/admin/update-lead/${editRowId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${user.token}`
...
useEffect(() => {
  const fetchData = async () => { 
    ...
    try {
      ...
      const response = await fetch(`https://vendor.safeshiphub.com/api/admin/${currentChart}-leads`, { headers });
